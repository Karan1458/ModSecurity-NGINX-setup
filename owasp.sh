...
if [[ $EUID -ne 0 ]]; then
	...
	cd /etc/nginx/modsec
	crs_latest=$(get_latest_release "coreruleset/coreruleset")
	#git clone https://github.com/SpiderLabs/owasp-modsecurity-crs.git
	git clone https://github.com/coreruleset/coreruleset.git owasp-modsecurity-crs -c advice.detachedHead=false --branch "$crs_latest"
